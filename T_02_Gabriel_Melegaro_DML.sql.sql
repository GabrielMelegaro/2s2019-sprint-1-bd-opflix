...
insert into Permissao values ('Administrador')
							,('Cliente');

select * from Permissao;

insert into Usuarios(Nome,Email,Senha,Permissao)
values('Helena','g@gmail.com','123456',3)

update Usuarios SET Permissao = 3
where Nome = 'Helena';

insert into Usuarios(Nome,Email,Senha,Permissao)
values('Roberto','r@gmail.com','123123',4)

insert into Usuarios(Nome,Email,Senha,Permissao)
values('Guilherme','guiga@gmail.com','112233',4)
...
insert into Lancamento(Titulo,IdSinopse,Duracao,IdCategoria,IdTipo,DataLancamento,IdPlataforma) values('A Hora do Pesadelo',26,'02:12:00',1,1,'27-11-1986',12);
insert into Lancamento(Titulo,IdSinopse,Duracao,IdCategoria,IdTipo,DataLancamento,IdPlataforma) values('Os Simpsons',27,'23:37:00',3,1,'17-12-1989',12);
insert into Lancamento(Titulo,IdSinopse,Duracao,IdCategoria,IdTipo,DataLancamento,IdPlataforma) values('La Casa De Papel 3',28,'12:53:00',2,1,'31-10-2010',12);
insert into Lancamento(Titulo,IdSinopse,Duracao,IdCategoria,IdTipo,DataLancamento,IdPlataforma) values('O Rei Leão',29,'01:54:00',2,2,'08-07-1994',15);
insert into Lancamento(Titulo,IdSinopse,Duracao,IdCategoria,IdTipo,DataLancamento,IdPlataforma) values('O Retorno de Johnny English',30,'01:42:00',3,2,'28-10-2010',13);
insert into Lancamento(Titulo,IdSinopse,Duracao,IdCategoria,IdTipo,DataLancamento,IdPlataforma) values('Os Vingadores: Ultimato',29,'01:54:00',23,2,'08-07-1994',15);
insert into Lancamento(Titulo,IdSinopse,Duracao,IdCategoria,IdTipo,DataLancamento,IdPlataforma) values('Toy Story 4',29,'01:54:00',25,2,'08-07-1994',15);
insert into Lancamento(Titulo,IdSinopse,Duracao,IdCategoria,IdTipo,DataLancamento,IdPlataforma) values('Velozes & Furiosos: Hobbs e Shaw',29,'01:54:00',23,2,'08-07-1994',15);
update Lancamento SET Titulo  =  'La Casa De Papel - 3º Temporada'
where IdLancamento = 54;

delete from Lancamento
where IdLancamento = 57;
